<template>
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-4">
                <indicador titulo="Profissionais Cadastrados" indicador="225" bg="bg-light" color="text-dark"></indicador>
            </div>
            <div class="col-4">
                <indicador titulo="Visitantes Online" :indicador="usuariosOnline" bg="bg-dark" color="text-white"></indicador>
            </div>
        </div>
...
export default {
    ...
    methods: {
        getUsuariosOnline() {
            this.usuariosOnline = Math.floor(Math.random() * 101)  // gerando um valor inteiro entre 0 e 100
        }
    },
    created() {
